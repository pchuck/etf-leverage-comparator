...
```{r dji_lm}
  ...
  ddm.fit
```
The slope of the DDM model is `r ddm.fit$coef[2]`,
...
* Over periods of mostly monotonic returns in the underlying index, leveraged ETF's can significantly outperform the simulated/ideal ETF returns.
  * Since its inception, the DDM leveraged ETF's annualized return **(`r round(ddm.return.annual * 100, digits=2)`%)** outperformed the simulated 2x ETF return **(by `r round(ddm.return.annual / p2x.return.annual, digits=2)`x)**.
